...
export default {
  ...
  data() {
    return {
      hasAnimated: false,
      client_images: [
        { client_pic: "/icons/partners/kijabe.svg" },
        { client_pic: "/icons/partners/chunic.svg" },
        { client_pic: "/icons/partners/boresha.svg" },
        { client_pic: "/icons/partners/mosop.svg" },
        { client_pic: "/icons/partners/jtl.svg" },
        { client_pic: "/icons/partners/skyline.svg" },
        { client_pic: "/icons/partners/centum.svg" },
        { client_pic: "/icons/partners/tkdm.svg" },
